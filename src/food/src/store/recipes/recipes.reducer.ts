...
import { recipesLoad, recipesLoadSuccess, recipesLoadError, recipesPatchSuccess, recipesAddSuccess } from './recipes.actions';
...
export const recipesReducer = createReducer(
    ...
    on(recipesAddSuccess, newRecipeAddSuccess, (state, action) => setState(state, {
